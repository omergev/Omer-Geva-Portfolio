export const techStack = {
  technologies: [
    ...
    { iconName: "/icons/Integrity.png", name: "Integrity" },
    { iconName: "/icons/jenkins.svg", name: "Jenkins" },
    { iconName: "/icons/dot-net.svg", name: ".NET" },
  ...
  languages: [
    ...
    { iconName: "/icons/ts-square.svg", name: "TypeScript" },
